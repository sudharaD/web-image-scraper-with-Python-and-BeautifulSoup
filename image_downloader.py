...
class ImageDownloader():
    ...
    def download_images_with_keywords(self):
        ...
        def download_images_internal(current_url, depth):
            ...
            image_tags = soup.find_all('img', {'alt': lambda x: x and any(keyword.lower() in x.lower() for keyword in self.keywords)})
            for img_tag in image_tags:
                ...
                if img_url and self.download_count < self.max_images:
                    ...
                    img_filename = os.path.join(self.output_folder, f'{"_".join(self.keywords)}_{self.download_count + 1}.jpg')
